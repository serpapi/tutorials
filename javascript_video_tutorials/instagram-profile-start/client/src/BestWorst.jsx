...
function BestWorst({ igHandle }) {
  ...
  const sortByLikes = () => {
    ...
    const sorted = posts
      ...
      .slice(0, 50)
      .sort((a, b) => Number(b.media_preview_likes_count) - Number(a.media_preview_likes_count));
            ...
            {highestPost && (
              ...
              >
                ...
                <div className="post-overlay">
                  <span>♥ {highestPost.media_preview_likes_count?.toLocaleString()}</span>
                  <span>
          ...
          <div id="lowest-likes">
            ...
            {lowestPost && (
              ...
              >
                ...
                />
                <div className="post-overlay">
                  <span>♥ {lowestPost.media_preview_likes_count?.toLocaleString()}</span>
                  <span>
